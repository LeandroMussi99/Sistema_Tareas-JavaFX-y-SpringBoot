...
public class IndexControlador implements Initializable {
    ...
    private void configurarColumnas(){
        ...
        nombreTareaColumna.setCellValueFactory(new PropertyValueFactory<>("nombre_tarea"));
    ...
    public void cargarTareaFormulario(){
        ...
        if(tarea != null){
           ...
           nombreTareaTexto.setText(tarea.getNombre_tarea());
    ...
    private void recolectarDatosFormulario(Tarea tarea){
        ...
        tarea.setNombre_tarea(nombreTareaTexto.getText());
